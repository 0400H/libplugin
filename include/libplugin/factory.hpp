...
#define GEN_FACTORY_RAW_SYMBOL_PAIR(FACTORY, SYMBOL_NAME, LIB_NAME) \
    { GEN_RAW_TYPE_NAME(LIB_NAME, SYMBOL_NAME), FACTORY_VIEW_SYMBOL(FACTORY, SYMBOL_NAME, LIB_NAME, 0) }
